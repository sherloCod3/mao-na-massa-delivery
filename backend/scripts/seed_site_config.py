...
SEED_CONFIGS: list[dict] = [
    # ─── Hero ────────────────────────────────────────────────
    {"chave": "hero_title", "valor": "Salgados & Doces Artesanais", "tipo": "text", "grupo": "hero"},
    {"chave": "hero_subtitle", "valor": "Feitos com ingredientes selecionados e muito carinho para tornar seu dia mais saboroso", "tipo": "text", "grupo": "hero"},
    ...
    {"chave": "about_content", "valor": "Tudo começou na cozinha de casa, com a vontade de transformar receitas de família em momentos especiais. Hoje, levamos todo esse carinho até você, com salgados e doces feitos artesanalmente, ingredientes frescos e aquele sabor que só o preparo caseiro tem.", "tipo": "text", "grupo": "about"},
    ...
    {"chave": "contato_horario", "valor": "Seg-Sex: 8h às 18h\nSáb: 8h às 12h", "tipo": "text", "grupo": "contato"},

    # ─── Delivery ────────────────────────────────────────────
    {"chave": "delivery_taxa", "valor": "Grátis", "tipo": "text", "grupo": "delivery"},
    {"chave": "delivery_raio", "valor": "Entregamos em toda a cidade", "tipo": "text", "grupo": "delivery"},
